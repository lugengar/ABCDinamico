...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 03-09-2024 a las 21:04:25
...
(42, 'Tecnicatura en Trabajo Social', '', 'Técnico en trabajo social'),
...
(42, 'mail', 'correo', 'uni@gmail.com', 13);
...
(58, 'daa', 40, 10),
(59, 'tecnicaturatrabajosocial77', 28, 13);
...
(5, 'luciano', 'barbini', 'luciano.barbinii@gmail.com', '$2y$10$DlR9HNVKjy2gRxI9NeraZ.Kh93uHol4GRbe2tikE/sY');
...
--
ALTER TABLE `planestudio`
  MODIFY `id_planestudio` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=60;
...
--
ALTER TABLE `contacto`
  ADD CONSTRAINT `fk_establecimiento` FOREIGN KEY (`fk_establecimiento`) REFERENCES `establecimiento` (`id_establecimiento`);
...
--
ALTER TABLE `imagenes`
  ADD CONSTRAINT `fk_establecimiento3` FOREIGN KEY (`fk_establecimiento`) REFERENCES `establecimiento` (`id_establecimiento`);
