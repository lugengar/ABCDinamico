...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 07-09-2024 a las 20:11:13
...
CREATE TABLE `carrera` (
  ...
  `tipo_carrera` enum('Licenciatura','Tecnicatura','Profesorado','Enfermería','Ingeniería') NOT NULL
...
(41, 'Profesorado de Inglés', 'Forma profesionales en el uso de la comunicación para promover el desarrollo social, cultural y económico en comunidades y organizaciones. Los estudiantes adquieren habilidades en periodismo, diseño gráfico, producción audiovisual y gestión de proyectos sociales.', 'Profesorado de inglés', 'Profesorado'),
