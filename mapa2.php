<?php
    // <iframe src="mapa2.php" loading="lazy" frameborder="0"></iframe>
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="capa">
        <div class="mapa" id="mapa">
            ...
            <button class="puntero distritomapa" style="left: 920vh; top: 190vh;"><span class="nombrepuntero" id="nombrepuntero"></span>Tigre</button>
            <button class="puntero distritomapa" style="left: 895vh; top: 188vh;"><span class="nombrepuntero" id="nombrepuntero"></span>Escobar</button>
            <button class="puntero distritomapa" style="left: 923vh; top: 207vh;"><span class="nombrepuntero" id="nombrepuntero"></span>San Fernando</button>
            <button class="puntero distritomapa" style="left: 932vh; top: 215vh;"><span class="nombrepuntero" id="nombrepuntero"></span>San Isidro</button>
            <button class="puntero distritomapa" style="left: 935vh; top: 223vh;"><span class="nombrepuntero" id="nombrepuntero"></span>Vicente Lopez</button>
